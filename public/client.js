...
////////////////////////////////////////////////////////////
    ...
    var texture1 = new THREE.TextureLoader().load('./jsm/model/pedret-interior_meshed_tex.png');
    var material1 = new THREE.MeshStandardMaterial({ map: texture1, flatShading: true });

    const loader1 = new PLYLoader();

    loader1.load(
        './jsm/model/pedret-interior_meshed_simplified.ply',
...
function createPanel() {
    ...
    var maps = ["St de Pedret", "The cave", "Ollantaytambo", "Art gallery"]
